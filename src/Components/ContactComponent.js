...
import {BreadcrumbItem, Breadcrumb, Button, Label, FormGroup, FormFeedback, Col, Form, Input} from 'reactstrap';
...
export class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        errors.firstname = 'First Name Not Less than 3 Characters';
        else if(this.state.touched.lastname && lastname.length > 10)
        errors.lastname = 'Last Name not greater than 10 characters';
